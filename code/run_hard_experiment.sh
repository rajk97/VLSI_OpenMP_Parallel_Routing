...
# Quick Hard Input Analysis - Speedup + Tracy Profiles
# Focus: hard_4096.txt only, threads: 1, 2, 4, 8

TRACY_CAPTURE="/home/raj/Documents/Projects/system_software/tracy/capture/build/tracy-capture"
INPUT="inputs/timeinput/hard_4096.txt"
THREADS_LIST=(1 2 4 8)
ITERATIONS=5
BATCH=1

# Experiment name
EXPERIMENT_NAME="hard_optimized"
...
{
    echo "Hard 4096 Speedup Analysis"
    echo "Experiment: $EXPERIMENT_NAME"
    echo "Date: $(date)"
    echo "=========================================="
    echo ""
    ...
    echo "  Compiler: Optimized build (march=native, flto, ffast-math)"
    echo ""
    echo "=========================================="
    echo ""
} | tee "$SUMMARY_FILE"
...
for threads in "${THREADS_LIST[@]}"; do
    ...
    TRACE_FILE="${PROFILE_DIR}/hard_t${threads}.tracy"
    LOG_FILE="${LOGS_DIR}/hard_t${threads}.log"
    ...
    RESULT_LINE="  Threads: $threads | Time: ${COMP_TIME}s | Speedup: ${SPEEDUP}x"
