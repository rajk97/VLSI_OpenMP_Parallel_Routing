...
# All results stored in user-specified folder
...
# Ask user for results folder name
echo "=== Quick Medium Analysis ==="
echo ""
read -p "Enter results folder name (e.g., experiment_1, baseline_test): " FOLDER_NAME
...
{
    echo "Medium 4096 Speedup Analysis"
    echo "Experiment: $FOLDER_NAME"
    echo "Date: $(date)"
    echo "=========================================="
    echo ""
    echo "Configuration:"
